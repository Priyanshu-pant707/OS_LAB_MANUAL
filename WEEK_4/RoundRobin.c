...
int main()
{
    ...
    while (completed != n)
    {
        ...
        // Check which new processes need to be added to Ready Queue
        for (int i = 1; i < n; i++)
        {
        ...
        // If current process still has burst time left → push back into queue
    ...
    // Sort again by PID for printing
